...
STRINGS = {
    "de": {
        ...
        "notify.on_warning": "bei Warnungen",
        ...
        "preview.hint": "Was ein Automatiklauf ändern würde - ohne etwas zu ändern. "
                        "Es wird nichts geschrieben, weder in die Dateien noch in "
                        "die Datenbank.",
        "preview.due": "zu prüfen",
        "preview.would_write": "wird geschrieben",
        "preview.unchanged": "bleibt",
        "preview.current": "bisher",
        "preview.result": "Ergebnis",
        "preview.sample": "Gezeigt wird der Anfang der Liste. Für alle Einträge "
                          "dauert die Vorschau so lange wie der Lauf selbst.",
        "preview.go": "Lauf jetzt starten",
        "preview.nothing": "Nichts zu tun.",
        ...
        "log.level_warn": "Warnungen",
        "log.level_ok": "Erledigt",
        "log.level_info": "Info",
        "log.source": "Quelle",
        "log.message": "Meldung",
    ...
    "en": {
        ...
        "preview.hint": "What a run would change, without changing anything. "
                        "Nothing is written, neither to the files nor to the "
                        "database.",
        "preview.due": "due",
        "preview.would_write": "would be written",
        "preview.unchanged": "stays",
        "preview.current": "current",
        "preview.result": "Result",
        "preview.sample": "Only the start of the list is shown. Previewing every "
                          "entry would take as long as the run itself.",
        "preview.go": "Start the run now",
        "preview.nothing": "Nothing to do.",
        ...
        "log.time": "Time",
        "log.level": "Level",
        "log.level_error": "Errors",
        "log.level_warn": "Warnings",
        "log.level_ok": "Done",
        "log.level_info": "Info",
        "log.source": "Source",
        "log.message": "Message",
